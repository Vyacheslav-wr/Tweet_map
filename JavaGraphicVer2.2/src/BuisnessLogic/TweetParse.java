...
public class TweetParse {
    public static ArrayList<Tweet> TweetRead(String filename)
    {
        ...
        try
        {
            File file = new File("C:\\Users\\User\\Desktop\\Tweet_map-main\\program\\tweets\\" + filename);
    ...
    public static Dictionary WordsRead(String filename)
    {
        ...
        try
        {
            File file = new File("C:\\Users\\User\\Desktop\\Tweet_map-main\\program\\" + filename);
            FileReader fr = new FileReader(file);
            BufferedReader reader = new BufferedReader(fr);
    ...
    public static Dictionary sentiments;
    public static ArrayList<State> states;
    public static Dictionary statestweets;
    public static Dictionary o;
    public static ArrayList<State> ChangeStates;

    public static void TweetParsing(String str)
    {
        // Список твитов
        tweets = TweetRead(str);

        // Словарь слов и весов <String, Double>
        sentiments = WordsRead("sentiments.csv");

        // Список штатов
        states = StatesRead("states.json");

        // Словарь штатов и твитов <State, ArrayList<Tweet>>
        statestweets = StatesAndTweets(tweets, states);

        // Словарь имени штатов и мнения <String, Double>
        o = GetOpinion(tweets, sentiments, statestweets);
        System.out.println("");
